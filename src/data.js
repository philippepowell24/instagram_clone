...
export const defaultUser = {
  ...
  username: 'username',
  name: 'name',
  profile_image: 'https://source.unsplash.com/random/450x450', // profile_image:
...
export function getDefaultUser() {
  return {
    ...
    username: 'username',
    name: 'name',
    profile_image: 'https://source.unsplash.com/random/450x450',
  };
}
...
export const defaultPost = {
  ...
  user: defaultUser,
  media: 'https://source.unsplash.com/random/450x450',
  comments: [],
